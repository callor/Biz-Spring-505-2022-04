...
public class QualifyConfig {
	...
	public final static String ADDR_SERVCE_V1 = "addrServiceV1";
	public final static String ADDR_SERVCE_V2 = "addrServiceV2";
	public final static String ADDR_SERVCE_V3 = "addrServiceV3";
